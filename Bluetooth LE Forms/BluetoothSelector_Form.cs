...
namespace Bluetooth_LE_Forms {
    public partial class BluetoothSelector_Form : Form {
        ...
        public BluetoothSelector_Form() {
            InitializeComponent();

            getBluetoothServices();
        }

        public async void getBluetoothServices() {
                ...
                if (device == null) {
                    ...
                    if (result.Status == GattCommunicationStatus.Success) {
                        ...
                        foreach (var service in services) {
                            BluetoothServiceList.Items.Add(service.Uuid);
                        }
                    }
                    break;
                }
        ...
        private static void Characteristic_ValueChanged(GattCharacteristic sender, GattValueChangedEventArgs args) {
            ...
            BluetoothServiceList.Items.Add(value);
        }
                            ...
                            if (service.Uuid.ToString("N").Substring(4, 4) == LED_SERVICE_ID) {
                                ...
                                if (result.Status == GattCommunicationStatus.Success) {
                                    ...
                                    foreach (LedStrip led in ledStrips) {
                                        ...
                                        await led.setRGB(0xFF, 0xFF, 0x00);
                                    }
                                }
                            }
                        }
